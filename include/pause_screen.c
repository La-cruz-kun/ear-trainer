...
UpdatePauseScreen (void)
{
    ...
    calcMenuButtonPosition (
        &buttons[PAUSE_SCREEN][0], &buttons[PAUSE_SCREEN][1],
        &buttons[PAUSE_SCREEN][2], &buttons[PAUSE_SCREEN][3], NULL);
}
